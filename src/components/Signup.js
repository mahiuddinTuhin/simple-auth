  ...
  const handlesignupWithEmail = (event) => {
    ...
    const verifyEmail = () => {
      sendEmailVerification(auth.currentUser)
        ...
        .catch((error) => {
          console.error("error of verification,", error);
        });
    };
        ...
        <div className="flex justify-center flex-1 max-w-screen-xl m-0 bg-white shadow sm:m-20 sm:rounded-lg">
          ...
          <div className="p-6 lg:w-1/2 xl:w-5/12 sm:p-12">
            <div className="flex flex-col items-center mt-4">
              <h1 className="text-2xl font-extrabold xl:text-3xl">Register</h1>
                    ...
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                      <div className="relative w-auto my-6 mx-auto max-w-3xl">
                        ...
                        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                          ...
                          {/*body*/}
                          <div className="relative p-6 flex-auto bg-green-500">
                            <p className="my-4 text-slate-100 text-lg leading-relaxed">
                              Sign up done. Check your email for verfication.
                            </p>
                          </div>
                          {/*footer*/}
                          <button
